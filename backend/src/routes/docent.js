...
docentRouter.post('/create-exam', DocentController.createExam)
...
docentRouter.get('/info-attendance-to-report/:usuid/:cedid/:cecid/:asgcod/:optionSP', DocentController.getInfoAttendanceToReport)