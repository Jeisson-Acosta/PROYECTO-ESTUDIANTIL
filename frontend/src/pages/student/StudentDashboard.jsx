   ...
   // const total_materias = userLogin.total_materias;
    ...
    return (
        <div className="principal-content">
            <CircleChart endValue={100} value={80} labelCenter="Promedio" color="#4400ffff"/>

            <div className='stats-dashboard'>
                <StudentCard titulo="Materias Inscritas" valor={userLogin?.total_materias || 2} adicional="+2 en el ciclo" Icono={IconSubject}/>
